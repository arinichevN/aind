...
const ChannelParam CHANNEL_DEFAULT_PARAMS[] = {
	//{51, YES, 21, DEVICE_KIND_MAX7219, DISPLAY_ALIGNMENT_RIGHT, 3,4,5, SERIAL_MODE_CLIENT, CMD_GETR_CHANNEL_ERROR, 3000, SERIAL_ID1},
	//{52, YES, 22, DEVICE_KIND_MAX7219, DISPLAY_ALIGNMENT_RIGHT, 3,4,6, SERIAL_MODE_CLIENT, CMD_GETR_CHANNEL_ERROR, 3000, SERIAL_ID1},
	//{53, YES, 23, DEVICE_KIND_MAX7219, DISPLAY_ALIGNMENT_RIGHT, 3,4,7, SERIAL_MODE_CLIENT, CMD_GETR_CHANNEL_ERROR, 3000, SERIAL_ID1},
	
	{51, YES, DEVICE_KIND_TM1637, 4,3,0, DISPLAY_ALIGNMENT_RIGHT, SERIAL_ID1, SERIAL_MODE_CLIENT, 21, CMD_GETR_CHANNEL_FTS, 3000},
	{52, YES, DEVICE_KIND_TM1637, 6,5,0, DISPLAY_ALIGNMENT_RIGHT, SERIAL_ID1, SERIAL_MODE_CLIENT, 22, CMD_GETR_CHANNEL_FTS, 3000},
	{53, YES, DEVICE_KIND_TM1637, 8,7,0, DISPLAY_ALIGNMENT_RIGHT, SERIAL_ID1, SERIAL_MODE_CLIENT, 23, CMD_GETR_CHANNEL_FTS, 3000},
};
