...
const ChannelParam CHANNEL_DEFAULT_PARAMS[] = {
	{21, YES, DEVICE_KIND_TM1637, 4,3,0, DISPLAY_ALIGNMENT_RIGHT, SERIAL_ID1, SERIAL_MODE_SERVER, 21, CMD_GETR_CHANNEL_FTS, 3000, 2},
	//{22, YES, DEVICE_KIND_TM1637, 6,5,0, DISPLAY_ALIGNMENT_RIGHT, SERIAL_ID1, SERIAL_MODE_SERVER, 22, CMD_GETR_CHANNEL_FTS, 3000, 2},
	//{23, YES, DEVICE_KIND_TM1637, 8,7,0, DISPLAY_ALIGNMENT_RIGHT, SERIAL_ID1, SERIAL_MODE_SERVER, 23, CMD_GETR_CHANNEL_FTS, 3000, 2}
};
