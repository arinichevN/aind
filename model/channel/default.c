...
const ChannelParam CHANNEL_DEFAULT_PARAMS[] = {
	...
	//{21, YES, DEVICE_KIND_TM1637, 3,4,5, DISPLAY_ALIGNMENT_RIGHT, SERIAL_ID1, SERIAL_MODE_SERVER, 21, CMD_GETR_CHANNEL_FTS, 5000, 0},
	//{22, YES, DEVICE_KIND_TM1637, 3,4,6, DISPLAY_ALIGNMENT_RIGHT, SERIAL_ID1, SERIAL_MODE_SERVER, 22, CMD_GETR_CHANNEL_FTS, 5000, 0},
	//{23, YES, DEVICE_KIND_TM1637, 3,4,7, DISPLAY_ALIGNMENT_RIGHT, SERIAL_ID1, SERIAL_MODE_SERVER, 23, CMD_GETR_CHANNEL_FTS, 5000, 0}
};
